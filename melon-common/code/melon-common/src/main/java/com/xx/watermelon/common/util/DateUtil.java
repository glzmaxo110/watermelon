...
public class DateUtil {
     ...
     * @return 日期
     */
    public static LocalDateTime stringToLocalDateTime(@NotBlank String dateStr, @NotBlank String format) {
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern(format);
     ...
     * @return 日期
     */
    public static LocalDate stringToLocalDate(@NotBlank String dateStr, @NotBlank String format) {
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern(format);
    ...
    /**
     * 不推荐使用，建议使用getWeekOfDate(Date  date) 方法
     * 根据传入日期返回星期几
     *
     * @param date 日期
    ...
    public static List getStartAndEndOfWeek(LocalDate beginDate, LocalDate endDate) {
        ...
        Map<String, Object> weekDates = new HashMap<String, Object>();
        ...
        while (endOfWeek.isBefore(endDate)) {
            ...
            weekDates = new HashMap<String, Object>();
            weekDates.put("startOfWeek", startOfWeek);
            weekDates.put("endOfWeek", endOfWeek);
            list.add(weekDates);
        }
    ...
    /**
     *
     * @param timestamp 转换格式
     * @return bool
     */
    public static String dateAndDate(String timestamp) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MMM/yyyy:HH:mm:ss",Locale.ENGLISH);
        TemporalAccessor rightNow=formatter.parse(timestamp);
        DateTimeFormatter formatterRn=DateTimeFormatter.ofPattern("YYYY-MM-dd HH:mm:ss");
        timestamp=formatterRn.format(rightNow);
        return timestamp;
    }
    /**
     *
     * @param timestamp 时间戳转换日期
     * @return bool
     */
//    public static String dateAndTimestamp(String timestamp) {
//
//
