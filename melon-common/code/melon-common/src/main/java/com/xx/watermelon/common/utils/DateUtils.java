...
import com.xx.watermelon.common.utils.validate.ValidateUtils;
...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	/**
	 * 设置当前时间的凌晨时间(如:现在是2017-12-11 01:22:33,结果为:2017-12-12 00:00:00)
	 * @param date
	 * @return
     */
	...
	/**
	 * 设置当前时间的当天截止时间(如:现在是2017-12-11 01:22:33,结果为:2017-12-11 23:59:59)
	 * @param date
	 * @return
     */
	public static Date setDayEndTime(Date date){
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
	 ...
	 * @return
	 */
	public static String getReqTime(Date d) {
		return HMS_FORMAT.format(d);
	}
	 ...
	 * @return
	 */
	public static Date getWeekStart1(Date date) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
	 ...
	 * @return
	 */
	public static Date getWeekEnd1(Date date) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
		int day_of_week = calendar.get(Calendar.DAY_OF_WEEK) - 1;
		if (day_of_week == 0)
	 ...
	 * 日期转换
	 */
	public static String changeLongToDate(Long dateValue) {
		try {
			Date date = new Date(dateValue);
			return SHORT_DATE_FORMAT.format(date);
		} catch (Exception e) {
			throw new RuntimeException("日期格式转换错误: " + e.getMessage());
		}
	}
	...
	public static void main(String[] args) {
		...
		//System.out.print(changeLongToDate(1517068800000L));
	}
}
