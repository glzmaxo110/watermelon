package com.zc.travel.common.web.utils;
...
public final class ResponseUtils {
	 ...
	 * @param text	文本
	 */
	public static void renderResultJson(HttpServletResponse response, String code, String text, Object data, String contentType) {
		JSONObject jsonObj = new JSONObject();
		jsonObj.put("code", code);
		jsonObj.put("message", text);
		jsonObj.put("data", data);
		render(response, contentType, jsonObj.toString());
	}
